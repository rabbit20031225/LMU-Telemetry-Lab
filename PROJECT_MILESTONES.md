...
## 🟢 [2026-06-06] Telemetry v1.4.3 - 2026 車輛陣容與 Logo 識別升級

### 🌟 核心突破
*   **2026 車輛與 Logo 識別**：因應 Le Mans Ultimate 遊戲 v1.3.3 版本更新，新增並整合 2026 年最新車輛陣容的識別（包含 Adess AD25、BMW M Hybrid V8 Evo、Ferrari 296 LMGT3 Evo、Ford Mustang LMGT3 Evo、Porsche 911 GT3 R LMGT3 Evo、Toyota GR010 2026 等），並更新其對應的方向盤貼圖與品牌 Logo。

### 🚀 專案影響
*   v1.4.3 確保與 Le Mans Ultimate 官方最新版本（v1.3.3）的完美相容性，讓玩家能無痛載入並精確分析 2026 賽季全新車型的遙測數據。

🟢 [2026-06-06] Telemetry v1.4.3 - 2026 Car Lineup & Logo Recognition Update

### 🌟 Key Breakthroughs
*   **2026 Car Lineup & Logo Recognition**: Fully aligned with Le Mans Ultimate game v1.3.3. Integrates support and mapping for the 2026 vehicle roster (including Adess AD25, BMW M Hybrid V8 Evo, Ferrari 296 LMGT3 Evo, Ford Mustang LMGT3 Evo, Porsche 911 GT3 R LMGT3 Evo, Toyota GR010 2026, etc.), updated with corresponding steering wheel skins and brand logos.

### 🚀 Project Impact
*   v1.4.3 ensures seamless compatibility with the latest LMU v1.3.3 official release, allowing users to accurately parse and analyze the telemetry data of the newly introduced 2026 season vehicles.
