            ...
            >
                <div className="glass-content relative z-10 flex flex-col items-center">
                    ...
                    <h2 className="text-3xl font-black tracking-tighter mb-2 bg-gradient-to-br from-white via-white to-white/40 bg-clip-text text-transparent italic uppercase px-2 text-center leading-tight">
                        {isCreating ? 'Create Profile' : 'Select Identity'}
                    </h2>
                    <p className="text-gray-500 text-sm mb-8 text-center font-medium tracking-tight px-4 leading-normal">
                        {isCreating ? 'Choose a name for your new telemetry workspace.' : 'Access your personal telemetry data and settings.'}
                    </p>
                        ...
                        {!isCreating ? (
                            <>
                                ...
                                >
                                    <div className="glass-content flex flex-col items-center gap-2">
                                        ...
                                        <span className="text-xs font-black uppercase tracking-widest text-gray-500 group-hover/new:text-white">New Workspace</span>
                                    </div>
                                </button>
                            </>
                        ) : (
                            <form onSubmit={handleCreate} className="w-full space-y-6 animate-in slide-in-from-right-4 duration-300 px-1">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-500 pl-4">Workspace Name</label>
                                    <input
                                        autoFocus
                                        type="text"
                                        value={newName}
